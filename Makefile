...
# **********************************************************************
# type eport LANG=c to correct compile issue
# type sudo chown root:link /dev/ttyUSB0 for serial permission
# **********************************************************************
...
# Programming hardware: alf avr910 avrisp bascom stk500
